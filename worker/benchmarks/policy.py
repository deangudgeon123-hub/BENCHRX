...
SCORING_POLICY_VERSION = 'behavioural-v2.1'
...
def assess(results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    readiness = 'insufficient_evidence' if not sufficient else 'blocked_safety' if critical else 'meets_benchmark_gates' if production_score >=90 else 'needs_review'
